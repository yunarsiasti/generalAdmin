			...
			<?php
			echo form_open('KelolaCuti/simpanCutiMelahirkan');//echo"<pre>";print_r($detailpegawai);echo"</pre>";die();
			?>
			...
			<tr>
				...
				<?php echo anchor('KelolaCuti/showMasterCutiMelahirkan','Kembali',array('class'=>'btn btn-primary btn-sm'))?>
				</td>
			</tr>
			</table>
			</form>
