			...
			<h1 class="h2">Request DinasLuar Pegawai</h1>
			</div>
			
			<?php
			echo form_open('KelolaDinasLuarUser/simpanDinasLuar');//echo"<pre>";print_r($pegawai);echo"</pre>";die();
			?>
			...
			<tr>
				...
				<?php echo anchor('KelolaDinasLuarUser/showMasterDinasLuar','Kembali',array('class'=>'btn btn-primary btn-sm'))?>
				</td>
			</tr>
			</table>
			</form>
