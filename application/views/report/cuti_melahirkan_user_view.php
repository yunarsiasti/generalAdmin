			...
			<h1 class="h2">Report Cuti Melahirkan Pegawai</h1>
			</div>
			
			<?php
			echo form_open('KelolaCutiUser/simpanCutiMelahirkan');//echo"<pre>";print_r($detailpegawai);echo"</pre>";die();
			?>
			<input type="hidden" name="counter" class="form-control" value=0>
			...
			<tr>
				...
				<td>
				<div class="col-sm-4"">
					<input type="hidden" name="kehadiran" class="form-control" value="11">
					<input type="text" name="cuti" class="form-control" disabled value="Cuti Melahirkan">
				</div>
				</td>
			</tr>
			<tr>
			...
			<tr>
				...
				<?php echo anchor('KelolaCutiUser/showMasterCutiMelahirkan','Kembali',array('class'=>'btn btn-primary btn-sm'))?>
				</td>
			</tr>
			</table>
			</form>
